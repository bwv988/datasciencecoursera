...
The mean number of steps taken is **9354.2295** and the median is **10395** 
...
It is interval number **104** which contains the maximum number of average steps. 
The running interval number is **835** and the maximum average step value is **206.1698.**
`
...
The total number of missing data values is **2304**.
...
Based on the new data set, the mean number of steps is **9354.2295** and the median number of steps is **10395**.
